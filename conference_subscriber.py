...
def post_worker(dwa, timeout, kp):
    while True:
        ...
        # РџРѕР»СѓС‡РµРЅРЅС‹Р№ СЂРµР·СѓР»СЊС‚Р° РЅР°РґРѕ РєР°Рє-С‚Рѕ РїРµСЂРµРґР°С‚СЊ РІ agenda
        # РќР°РїСЂРёРјРµСЂ, СЃРѕР·РґР°С‚СЊ СЃРїРёСЃРѕРє С‚СЂРѕРµРє Рё РІРѕСЃРїРѕР»СЊР·РѕРІР°С‚СЊСЃСЏ
        # kp.insert(triples)
