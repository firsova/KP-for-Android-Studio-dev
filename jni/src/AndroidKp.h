...
#include <jni.h>
/* Header for class petrsu_smartroom_android_srmic_KP */

#ifndef _Included_petrsu_smartroom_android_srmic_KP
#define _Included_petrsu_smartroom_android_srmic_KP
#ifdef __cplusplus
extern "C" {
#endif
#undef petrsu_smartroom_android_srmic_KP_MODE_PRIVATE
#define petrsu_smartroom_android_srmic_KP_MODE_PRIVATE 0L
#undef petrsu_smartroom_android_srmic_KP_MODE_WORLD_READABLE
#define petrsu_smartroom_android_srmic_KP_MODE_WORLD_READABLE 1L
#undef petrsu_smartroom_android_srmic_KP_MODE_WORLD_WRITEABLE
#define petrsu_smartroom_android_srmic_KP_MODE_WORLD_WRITEABLE 2L
#undef petrsu_smartroom_android_srmic_KP_MODE_APPEND
#define petrsu_smartroom_android_srmic_KP_MODE_APPEND 32768L
#undef petrsu_smartroom_android_srmic_KP_MODE_MULTI_PROCESS
#define petrsu_smartroom_android_srmic_KP_MODE_MULTI_PROCESS 4L
#undef petrsu_smartroom_android_srmic_KP_MODE_ENABLE_WRITE_AHEAD_LOGGING
#define petrsu_smartroom_android_srmic_KP_MODE_ENABLE_WRITE_AHEAD_LOGGING 8L
#undef petrsu_smartroom_android_srmic_KP_BIND_AUTO_CREATE
#define petrsu_smartroom_android_srmic_KP_BIND_AUTO_CREATE 1L
#undef petrsu_smartroom_android_srmic_KP_BIND_DEBUG_UNBIND
#define petrsu_smartroom_android_srmic_KP_BIND_DEBUG_UNBIND 2L
#undef petrsu_smartroom_android_srmic_KP_BIND_NOT_FOREGROUND
#define petrsu_smartroom_android_srmic_KP_BIND_NOT_FOREGROUND 4L
#undef petrsu_smartroom_android_srmic_KP_BIND_ABOVE_CLIENT
#define petrsu_smartroom_android_srmic_KP_BIND_ABOVE_CLIENT 8L
#undef petrsu_smartroom_android_srmic_KP_BIND_ALLOW_OOM_MANAGEMENT
#define petrsu_smartroom_android_srmic_KP_BIND_ALLOW_OOM_MANAGEMENT 16L
#undef petrsu_smartroom_android_srmic_KP_BIND_WAIVE_PRIORITY
#define petrsu_smartroom_android_srmic_KP_BIND_WAIVE_PRIORITY 32L
#undef petrsu_smartroom_android_srmic_KP_BIND_IMPORTANT
#define petrsu_smartroom_android_srmic_KP_BIND_IMPORTANT 64L
#undef petrsu_smartroom_android_srmic_KP_BIND_ADJUST_WITH_ACTIVITY
#define petrsu_smartroom_android_srmic_KP_BIND_ADJUST_WITH_ACTIVITY 128L
#undef petrsu_smartroom_android_srmic_KP_CONTEXT_INCLUDE_CODE
#define petrsu_smartroom_android_srmic_KP_CONTEXT_INCLUDE_CODE 1L
#undef petrsu_smartroom_android_srmic_KP_CONTEXT_IGNORE_SECURITY
#define petrsu_smartroom_android_srmic_KP_CONTEXT_IGNORE_SECURITY 2L
#undef petrsu_smartroom_android_srmic_KP_CONTEXT_RESTRICTED
#define petrsu_smartroom_android_srmic_KP_CONTEXT_RESTRICTED 4L
#undef petrsu_smartroom_android_srmic_KP_RESULT_CANCELED
#define petrsu_smartroom_android_srmic_KP_RESULT_CANCELED 0L
#undef petrsu_smartroom_android_srmic_KP_RESULT_OK
#define petrsu_smartroom_android_srmic_KP_RESULT_OK -1L
#undef petrsu_smartroom_android_srmic_KP_RESULT_FIRST_USER
#define petrsu_smartroom_android_srmic_KP_RESULT_FIRST_USER 1L
#undef petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_DISABLE
#define petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_DISABLE 0L
#undef petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_DIALER
#define petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_DIALER 1L
#undef petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SHORTCUT
#define petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SHORTCUT 2L
#undef petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SEARCH_LOCAL
#define petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SEARCH_LOCAL 3L
#undef petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SEARCH_GLOBAL
#define petrsu_smartroom_android_srmic_KP_DEFAULT_KEYS_SEARCH_GLOBAL 4L
/*
 * Class:     petrsu_smartroom_android_srmic_KP
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_petrsu_smartroom_android_srmic_KP_getProjectorClassObject
  (JNIEnv *, jclass);
